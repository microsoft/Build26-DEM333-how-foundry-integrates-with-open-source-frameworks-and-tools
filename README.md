...
- Invoke hosted agents from Copilot CLI through the generic A2A directory bridge in [docs/HOSTED_AGENT_DEPLOYMENT.md](docs/HOSTED_AGENT_DEPLOYMENT.md#5-enable-a2a-and-use-the-copilot-cli-bridge)
